...
import { Route, RouteType, RouteStop } from "@/lib/types";
...
function StopCard({ location, index, isLast, onClick }: {
  location: RouteStop["locations"]; index: number; isLast: boolean; onClick: () => void;
}) {
...
export function RouteDetailClient({ route, stops }: { route: Route; stops: RouteStop[] }) {
